...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.mTextViewDate.setText(mContext.getString(R.string.date)+ " " +currentItem.getDate());
        holder.mTextViewTime.setText(mContext.getString(R.string.time)+ " " +currentItem.getTime());
        holder.text_category.setText(mContext.getString(R.string.category)+ " " +currentItem.getCategory());
        holder.text_priority.setText(mContext.getString(R.string.priority)+ " " +currentItem.getPriority());
        holder.text_notes.setText(mContext.getString(R.string.note)+ " " +currentItem.getNotes());
    }
